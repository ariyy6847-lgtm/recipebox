...
RecipeBox is organized around a small set of focused modules. The goal is to keep the core small and let plugins, hooks, and configuration do the heavy lifting.

## Layout

- `src/recipebox/` - primary package source
